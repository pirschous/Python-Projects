...
class ParentWindow(Frame):
    def __init__(self, master):
        ...
        #Positions source button in GUI usin tkinter grid()
    ...
    def sourceDir(self):
        ...
        #The .inser method will insert the user selection to the source_dir Entry
    ...
    def transferFiles(self):
        ...
        for file in destination_files:
            ...
            if time_diff > time_day:
                ...
                print(file + ' was not transferred due to not being edited in the last 24 hours.')
